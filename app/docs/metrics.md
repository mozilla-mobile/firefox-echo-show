...
| --- | --- | --- | --- | --- | --- |
| legacy.ids.client_id |[uuid](https://mozilla.github.io/glean/book/user/metrics/uuid.html) |The client id from legacy telemetry.  |[1](https://github.com/mozilla-mobile/firefox-echo-show/issues/320)||never |
